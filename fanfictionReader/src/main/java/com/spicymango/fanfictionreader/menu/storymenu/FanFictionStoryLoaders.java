...
/**
 * Contains the loaders used to obtain FanFiction.net stories. Split out of the former
 * {@code StoryMenuLoaders} (Phase 2 of the FanFiction.net / AO3 separation) so that
 * FanFiction.net-only changes no longer require re-touching the AO3 loader that used to live
 * alongside them.
 *
 * @author Michael Chen
 */
final class FanFictionStoryLoaders {
